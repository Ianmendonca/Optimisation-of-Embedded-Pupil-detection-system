...
The main difference is in the pipeline used to detect the pupil, where the conept of Binarization is used instead of Canny edge detection.More about this is mentioned in the report attached and these changes can be found in the detect_pupil.py file. Please refer the file **detect.py** in **Rasberry-Pi directory** in the above mentioned repository for comparision.
...
Above you can see an example for a binarised image.
...
The above image shows the pipeline used in this project to detect the pupil.
